...
import { AlertCircle, Mountain, Eye, EyeOff } from "lucide-react";
        ...
        <div className="w-full lg:w-[60%] flex flex-col justify-center px-6 sm:px-10 lg:px-12 bg-[#0a0f18] relative overflow-y-auto">
          ...
          <div className="w-full max-w-[340px] mx-auto relative z-10 py-6">
            ...
            <div className="flex flex-col gap-2.5">
                <button onClick={handleGoogleSignIn} type="button" className="w-full flex items-center justify-center gap-2 py-3 border border-cream/10 rounded-lg hover:border-cream/30 hover:bg-cream/5 transition-all text-sm font-medium text-cream/80 shadow-sm">
